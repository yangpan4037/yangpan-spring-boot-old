...
/**
 * DruidConfiguration: druid 配置.
 *
 * @author: MrServer
 * @since: 17/9/27 上午11:00
 */
@Configuration
public class DruidConfiguration {
    ...
    public ServletRegistrationBean DruidStatViewServle2(){
        ...
        servletRegistrationBean.addInitParameter("deny","192.168.4.73");
        //登录查看信息的账号密码.
...
//    /**
//     * 编程注入  注意：同时进行了编程式的注入和配置的注入，配置的就无效了。
//     * 注册dataSouce，举个栗子，只注入了部分参数信息，其它的参数自行扩散思维。
//     * @param driver
//     * @param url
//     * @param username
//     * @param password
